...
class UpdateTransaction extends StatefulWidget {
  ...
  UpdateTransaction({required this.updateid});
...
class _UpdateTransactionState extends State<UpdateTransaction> {
  ...
  getdata()async
  {
    ...
    var data= await obj.getsingletarnsction(widget.updateid);
    _title.text = data[0]["title"].toString();
    _remark.text = data[0]["remark"].toString();
    _Amount.text = data[0]["Amount"].toString();
    _dateinput.text = data[0]["date"].toString();
    selected = data[0]["ctaegory"].toString();
